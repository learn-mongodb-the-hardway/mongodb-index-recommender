...
//        assertEquals(1, logEntries.size)
//        assertEquals(
//            BsonDocument.parse("""{ "aggregate" : "test", "pipeline" : [{ "${'$'}project" : { "output" : { "${'$'}mod" : ["-inf.0", 10.0] } } }], "cursor" : { } }"""),
...
//        assertEquals(1, logEntries.size)
//        assertEquals(
//            BsonDocument.parse("""{ "aggregate" : "test", "pipeline" : [{ "${'$'}project" : { "output" : { "${'$'}mod" : ["nan.0", 10.0] } } }], "cursor" : { } }"""),
//            (logEntries.first() as CommandLogEntry).command)
//    }
//
//    @Test
...
//        assertEquals(1, logEntries.size)
//        assertEquals(
//            BsonDocument.parse("""{ "aggregate" : "jstests_aggregation_strcasecmp", "pipeline" : [{ "${'$'}project" : { "a" : { "${'$'}strcasecmp" : [{ "${'$'}numberLong" : "0" }, "1970-01-01t00:00:00"] } } }], "cursor" : { } }"""),
//            (logEntries.first() as CommandLogEntry).command
//        )
//    }
//
